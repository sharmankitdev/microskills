...
|---|---|---|---|---|
| finding | yes | object | One review finding or claim produced upstream (e.g. by review-dimension, collect-findings, or extract-closure-claims): carries its id, the location it cites within the artifact (file plus hunk/lines, or section plus lines), a description of the claimed issue or claim, and its claimed severity where one applies. | — |
